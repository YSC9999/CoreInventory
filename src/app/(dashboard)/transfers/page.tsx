...
import { ArrowRightLeft, MoreHorizontal, CheckCircle2 } from "lucide-react";
        ...
        <Table>
          ...
          <TableBody>
            {transfersData.map((transfer) => (
              <TableRow key={transfer.id} className="stagger-row border-border hover:bg-primary/5 transition-colors">
                <TableCell className="font-mono font-medium text-foreground py-4">{transfer.id}</TableCell>
